...
_$_PcCase _$$_PcCaseFromJson(Map<String, dynamic> json) => _$_PcCase(
      ...
      caseSize: CaseSize.fromJson(json['size'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$_PcCaseToJson(_$_PcCase instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'producer': instance.caseProducer,
      'size': instance.caseSize,
      'formFactor': instance.formFactor,
      'powerSupplyLocation': instance.casePowerSupplyLocation,
