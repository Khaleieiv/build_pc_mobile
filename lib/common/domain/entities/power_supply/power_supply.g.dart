...
_$_PowerSupply _$$_PowerSupplyFromJson(Map<String, dynamic> json) =>
    _$_PowerSupply(
      ...
      powerSupplyProtectionFunctions:
          (json['powerSupplyProtectionFunctions'] as List<dynamic>)
...
Map<String, dynamic> _$$_PowerSupplyToJson(_$_PowerSupply instance) =>
    <String, dynamic>{
      'id': instance.id,
      'powerSupplyProducer': instance.powerSupplyProducer,
      'name': instance.name,
      ...
      'powerSupplyProtectionFunctions': instance.powerSupplyProtectionFunctions,
