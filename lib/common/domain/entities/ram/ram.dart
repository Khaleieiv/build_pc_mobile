...
class Ram with _$Ram implements BaseComponent{
  const factory Ram({
    ...
    @JsonKey(name: 'producer') required Producers ramProducer,
    @JsonKey(name: 'memoryType') required RamMemoryType ramMemoryType,
    required int memoryCapacity,
    required int frequency,
    @JsonKey(name: 'timings') required RamTimings? ramTimings,
